...
class SharedPreferences {
  ...
  static MethodChannelSharedPreferencesStore get _store =>
      MethodChannelSharedPreferencesStore.instance;
  ...
  List<String>? getStringList(String key) =>
      (_preferenceCache[key] is List<String>)
          ? (_preferenceCache[key] as List<String>).toList()
          : null;
  ...
  Future<void> reload() async {
    ...
    _preferenceCache.clear();
    if (preferences != null) _preferenceCache.addAll(preferences);
  }
}
